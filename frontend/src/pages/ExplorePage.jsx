...
function ExplorePage() {
  ...
  // Check if user profile was updated recently (within last 24 hours)
                  ...
                  return (
                    ...
                    >
                      ...
                      {isRecentlyUpdated(person.lastUpdatedAt) && (
                        <div className="absolute top-12 left-3 bg-gradient-to-r from-purple-500 to-pink-500 px-2 py-1 rounded-full shadow-md animate-pulse" title="Profile recently updated">
                          <div className="flex items-center gap-1">
                            <Sparkles className="size-3 text-white" />
                            <span className="text-xs text-white font-semibold">Just Updated</span>
                          </div>
                        </div>
                      )}
        ...
        <>
          ...
          <div className="fixed top-0 right-0 w-full md:w-[450px] h-full bg-base-100 shadow-xl z-50 p-6 overflow-y-auto animate-slideLeft">
            ...
            <div className="flex flex-col items-center mt-6">
              ...
              {/* Recently Updated Badge in Modal */}
              {isRecentlyUpdated(selected.user.lastUpdatedAt) && (
                <div className="mt-2 flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full shadow-md animate-pulse">
                  <Sparkles className="size-4 text-white" />
                  <span className="text-sm text-white font-semibold">Just Updated Profile</span>
                </div>
              )}
            </div>
