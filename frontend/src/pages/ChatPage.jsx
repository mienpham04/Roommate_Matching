...
function ChatPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-base-200/50 flex flex-col">
      <Navbar />

      <main className="grow flex p-4 gap-4 max-w-7xl mx-auto w-full">
        {/* Conversations List */}
        <div className="w-full md:w-1/3 bg-base-100 rounded-3xl shadow-lg overflow-hidden flex flex-col">
        ...
        {/* Chat Window */}
        <div className="hidden md:flex flex-1 bg-base-100 rounded-3xl shadow-lg overflow-hidden flex-col">
